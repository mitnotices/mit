...
<?php include_once "adminpan.php" ?> 
		...
		<div class="col-md-9" style="">
            ...
            <div class="panel-heading main-color-bg"><b style="color:;"> MIT NEWS DASHBOARD </b></div>
  ...
  while($row=mysql_fetch_array($query))
  {
    ...
    echo "
        ...
        <tr>
          ...
          <a href='delete_file.php?id=$id' class='btn btn-danger' onclick='return confirm('Are you sure want to Delete this Record ?');'>Delete</a></th>
